 ...
 *  and e order in which they are called, see `world.cpp`.
 */
...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        vector<VertexFormat> verticesTR
        {
            // Punct 0
            ...
            // PUNCT 3
            VertexFormat(glm::vec3(1, 2,  -1), glm::vec3(0, 1, 1)),
            ...
            // PUNCT 2
            VertexFormat(glm::vec3(1, 0,  -2), glm::vec3(0, 1, 0)),
            // PUNCT 3
            ...
            // PUNCT 2
            VertexFormat(glm::vec3(1, 0,  -2), glm::vec3(1, 1, 0)),
            // PUNCT 3
            VertexFormat(glm::vec3(1, 2,  -1), glm::vec3(1, 1, 0)),


            // Punct 0
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.5f, 0.2f, 0.3f)),
            // PUNCT 1
            VertexFormat(glm::vec3(2, 0,  0),  glm::vec3(0.5f, 0.2f, 0.3f)),
            // PUNCT 2
            VertexFormat(glm::vec3(1, 0,  -2),  glm::vec3(0.5f, 0.2f, 0.3f)),
            // PUNCT 3
            VertexFormat(glm::vec3(1, 2,  -1),  glm::vec3(0.5f, 0.2f, 0.3f)),



        };
        vector<unsigned int> indicesTR =
        {
            0, 2, 1,   
            5, 6, 7,   
            10, 8, 11,
        ...
        CreateMesh("tetrahedron", verticesTR, indicesTR);

        vector<VertexFormat> verticespt
        {
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 1)),
        ...
        vector<unsigned int> indicespt
        {
            0, 1, 2,
            0, 3, 2

        };
        CreateMesh("square", verticespt, indicespt);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-1.5f, 20, 5), glm::vec3(0.25f));

    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-1.5f, 2, 0), glm::vec3(0.95f));
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-2, 3.4f, -1), glm::vec3(0.95f));
