...
namespace implemented
{
    ...
    public:
        ...
        {
            // Translates the CameraTema3 using the `dir` vector computed from
            // `forward`. Movement will always keep the CameraTema3 at the same
        ...
        {
            // TODO(student): Translate the CameraTema3 using the `forward` vector.
        ...
        {
            // TODO(student): Translate the CameraTema3 using the `up` vector.
        ...
        void TranslateRight(float distance)
        {
            ...
            // You need to translate the CameraTema3 using the `right` vector.
            // Usually, however, translation using CameraTema3's `right` vector
            // is not very useful, because if the CameraTema3 is rotated around the
            // `forward` vector, then the translation on the `right` direction
            // will have an undesired effect, more precisely, the CameraTema3 will
        ...
        {
            // TODO(student): Rotate the CameraTema3 in third-person mode around
